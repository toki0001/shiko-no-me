...
- Phone presentation means `(max-width:600px) and (orientation:portrait)` in both JS and CSS. Test tablet portrait and phone landscape as nonmodal right panels. Keep inspector/add bar/background interactivity in sync; test rotating with the note drawer open as well.
